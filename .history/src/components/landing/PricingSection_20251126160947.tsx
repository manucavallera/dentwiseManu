      ...
      <div className='relative z-10 max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            Reservá turnos gratis y mejorá a un plan premium para consultas de
            IA ilimitadas. Ideal para un seguimiento dental continuo.
          </p>
        </div>
        ...
        <div className='grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
                ...
                <div className='space-y-4'>
                  <div className='flex items-start gap-3'>
                    ...
                    <span className='text-sm'>
                      Reservas de turnos ilimitadas
                    </span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                      Encontrá dentistas en tu zona
                    </span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Soporte por chat básico</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Recordatorios de turnos</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='relative group'>
            ...
            <div className='relative bg-gradient-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105'>
              <div className='space-y-6'>
                <div className='space-y-3'>
                  <h3 className='text-2xl font-bold'>IA Básico</h3>
                  <div className='flex items-end gap-1'>
                  ...
                  <p className='text-muted-foreground'>
                    Consultas de IA + reserva de turnos
                  </p>
                </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Todo lo del plan Gratis</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                      10 llamadas de voz con IA por mes
                    </span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                      Guía y asesoramiento dental IA
                    </span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Evaluación de síntomas</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                  ...
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                      Historial y grabaciones de llamadas
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className='relative bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10'>
              <div className='space-y-6'>
                ...
                <div className='space-y-4'>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Todo lo del plan IA Básico</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Llamadas ilimitadas con IA</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Análisis dental avanzado IA</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                  ...
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>Soporte IA 24/7 prioritario</span>
                  </div>
                  <div className='flex items-start gap-3'>
                    <CheckCircleIcon className='w-5 h-5 text-primary mt-0.5 shrink-0' />
                    <span className='text-sm'>
                      Reportes detallados de salud dental
                    </span>
                  </div>
                </div>
              </div>
