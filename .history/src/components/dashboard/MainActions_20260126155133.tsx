      ...
      <Card className='relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30'>
        ...
        <CardContent className='relative p-8'>
          <div className='flex items-center gap-4 mb-6'>
            ...
            <div>
              <h3 className='text-2xl font-bold mb-2'>Asistente de Voz IA</h3>
              <p className='text-muted-foreground'>
                Consejos dentales al instante mediante voz
              </p>
            </div>
          </div>
          ...
          <div className='space-y-4'>
            <div className='flex items-center gap-3'>
              ...
              <span className='text-sm'>Disponibilidad 24/7</span>
            </div>
            <div className='flex items-center gap-3'>
              <div className='w-2 h-2 bg-primary rounded-full'></div>
            ...
            <div className='flex items-center gap-3'>
              <div className='w-2 h-2 bg-primary rounded-full'></div>
              <span className='text-sm'>Consejos para alivio del dolor</span>
            </div>
          </div>
      ...
      <Card className='relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30'>
        ...
        <CardContent className='relative p-8'>
          <div className='flex items-center gap-4 mb-6'>
            ...
            <div>
              <h3 className='text-2xl font-bold mb-2'>Reservar Turno</h3>
              <p className='text-muted-foreground'>
                Agendá con dentistas verificados en tu zona
              </p>
            </div>
          </div>
