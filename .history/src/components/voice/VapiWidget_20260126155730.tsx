    ...
    <div className='max-w-5xl mx-auto px-4 flex flex-col overflow-hidden pb-20'>
      ...
      <div className='text-center mb-8'>
        <h1 className='text-3xl font-bold font-mono'>
          <span>Hablá con Tu </span>
          <span className='text-primary uppercase'>Asistente Dental IA</span>
        </h1>
        <p className='text-muted-foreground mt-2'>
          Tené una conversación de voz con nuestra IA para recibir consejos y
          guía dental
        </p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
        ...
        >
          <div className='aspect-video flex flex-col items-center justify-center p-6 relative'>
            ...
            <h2 className='text-xl font-bold text-foreground'>Vos</h2>
            <p className='text-sm text-muted-foreground mt-1'>
              {user
            ...
            {messages.map((msg, index) => (
              ...
              >
                <div className='font-semibold text-xs text-muted-foreground mb-1'>
                  {msg.role === "assistant" ? "DentWise AI" : "Vos"}:
                </div>
            ...
            {callEnded && (
              <div className='message-item animate-in fade-in duration-300'>
                ...
                <p className='text-foreground'>
                  Llamada finalizada. ¡Gracias por usar DentWise AI!
                </p>
              </div>
            )}
          </div>
