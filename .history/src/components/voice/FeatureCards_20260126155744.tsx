    ...
    <div className='grid md:grid-cols-2 gap-8 mb-12'>
      ...
      <Card className='relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30'>
        ...
        <CardHeader className='relative'>
          ...
          <CardDescription>
            Pasos simples para empezar con el asistente de voz
          </CardDescription>
        </CardHeader>
        <CardContent className='relative space-y-4'>
          <div className='flex items-start gap-3'>
            ...
            <span className='text-sm'>
              Hacé clic en el micrófono para empezar a hablar
            </span>
          </div>
          <div className='flex items-start gap-3'>
            <div className='w-2 h-2 bg-primary rounded-full mt-2'></div>
            <span className='text-sm'>
              Preguntá sobre salud dental y tratamientos
            </span>
          </div>
          <div className='flex items-start gap-3'>
            <div className='w-2 h-2 bg-primary rounded-full mt-2'></div>
            <span className='text-sm'>
              Obtené respuestas de voz instantáneas de la IA
            </span>
          </div>
          <div className='flex items-start gap-3'>
            <div className='w-2 h-2 bg-primary rounded-full mt-2'></div>
            <span className='text-sm'>
              Mirá la transcripción en tiempo real
            </span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className='relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30'>
        ...
        <CardHeader className='relative'>
          ...
          <CardDescription>
            Capacidades avanzadas para el cuidado dental
          </CardDescription>
        </CardHeader>
        <CardContent className='relative space-y-4'>
