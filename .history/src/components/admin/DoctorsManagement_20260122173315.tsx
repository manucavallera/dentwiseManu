  ...
  return (
    <>
      <Card className='mb-12'>
        {/* 🔥 CAMBIO 1: El header se apila en móvil */}
        ...
        <CardContent>
          <div className='space-y-4'>
            {doctors.map((doctor) => (
              <div
                key={doctor.id}
                // 🔥 CAMBIO 2: Stack vertical en móvil (flex-col), horizontal en PC (sm:flex-row)
              ...
              >
                <div className='flex items-center gap-4 w-full sm:w-auto'>
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    {/* Info extra (email/phone) oculta o simplificada en móvil muy pequeño si quieres */}
                ...
                {/* Botones y estado - Ancho completo en móvil */}
